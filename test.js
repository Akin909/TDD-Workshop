...
if (typeof module !== 'undefined' && module.exports) {
  ...
  var getChange = require('./index.js'); // load our getChange method
}
...
test('getChange(215, 300) should return [50, 20, 10, 5]', function(assert) {
  ...
  assert.deepEqual(result, expected,"it worked");
})
...
test('Pay for £4 for item costing 12p should return [200, 100, 50, 20, 10, 5, 2, 1]', function(assert) {
